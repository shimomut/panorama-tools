    ...
    for line in fd:
        ...
        if op==1: # alloc
            ...
            if p in allocated_memories:
                print("Warning : [alloc] already allocated :", p, allocated_memories[p], (d["size"], d["module"], d["symbol"]) )
            ...
            if p2 in allocated_memories:
                print("Warning : [realloc] already allocated :", p2, allocated_memories[p2], (d["size"], d["module"], d["symbol"]) )

            allocated_memories[p2] = ( d["size"], d["module"], d["symbol"] )
